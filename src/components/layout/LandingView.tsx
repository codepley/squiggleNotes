...
export default function LandingView({ folders, onSelectNote, onCreateFolder }: Props) {
    ...
    return (
        <div className="w-full h-full bg-white overflow-y-auto flex flex-col">
            ...
            {/* Main Content */}
            <div className="flex-1 w-full max-w-5xl mx-auto px-8 pt-16 pb-12 flex flex-col items-center">

                {/* Welcome Message */}
                <div className="w-full max-w-2xl mb-8 flex items-center justify-center text-center">
                    <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight">
                        Welcome, Kushal! <span className="inline-block origin-[70%_70%] animate-[wave_2.5s_infinite]">👋</span>
                    </h2>
                </div>
                ...
                <div className="w-full max-w-2xl mb-12">
                    <div className="relative w-full">
                        ...
                        <input
                            ...
                            className="w-full pl-14 pr-6 py-4 bg-white border border-gray-300 rounded-2xl text-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all shadow-md hover:shadow-lg"
                        />
                    </div>
                </div>
